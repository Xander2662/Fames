...
-- -----------------------------------------------------
-- Schema fashion_in_games
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema fashion_in_games
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `fashion_in_games` DEFAULT CHARACTER SET utf8 ;
USE `fashion_in_games` ;
...
-- -----------------------------------------------------
-- Table `fashion_in_games`.`Games`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fashion_in_games`.`Games` (
...
-- -----------------------------------------------------
-- Table `fashion_in_games`.`Post`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fashion_in_games`.`Post` (
  ...
  CONSTRAINT `fk_Post_Games1`
    ...
    REFERENCES `fashion_in_games`.`Games` (`idGames`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `fashion_in_games`.`Report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fashion_in_games`.`Report` (
