...
echo "<div class='title'style='border-color:rgb(".explode("R", $color)[1].");'> CARD TITLE</div>";
...
echo "<img class='picture' style='border-color:rgb(".explode("R", $color)[1].");' src='../../public/usrimg/kokos.jpeg'>";
